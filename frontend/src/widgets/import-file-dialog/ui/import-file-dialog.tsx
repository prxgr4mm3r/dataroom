...
const DRIVE_BROWSER_FILTER_BUTTON_CLASS =
                ...
                >
                  ...
                  <Group gap={6} wrap="nowrap" className="flex-none max-[860px]:justify-start">
                    <Button
                      ...
                      variant="default"
                      className={cx(
                        DRIVE_BROWSER_FILTER_BUTTON_CLASS,
                        driveTab === 'recent' && DRIVE_BROWSER_FILTER_BUTTON_ACTIVE_CLASS,
                      )}
                    ...
                    <Button
                      ...
                      className={cx(
                        DRIVE_BROWSER_FILTER_BUTTON_CLASS,
                        driveTab === 'my_drive' && DRIVE_BROWSER_FILTER_BUTTON_ACTIVE_CLASS,
                      )}
                    ...
                    <Button
                      ...
                      className={cx(
                        DRIVE_BROWSER_FILTER_BUTTON_CLASS,
                        driveTab === 'shared' && DRIVE_BROWSER_FILTER_BUTTON_ACTIVE_CLASS,
                      )}
                  ...
                  >
                    ...
                    <Group gap={6} wrap="nowrap" className="flex-none max-[860px]:justify-start">
                      <Button
                        ...
                        className={cx(
                          DRIVE_BROWSER_FILTER_BUTTON_CLASS,
                          driveSort === 'modified_desc' && DRIVE_BROWSER_FILTER_BUTTON_ACTIVE_CLASS,
                        )}
                      ...
                      <Button
                        ...
                        className={cx(
                          DRIVE_BROWSER_FILTER_BUTTON_CLASS,
                          driveSort === 'name_asc' && DRIVE_BROWSER_FILTER_BUTTON_ACTIVE_CLASS,
                        )}
                      ...
                      <Button
                        ...
                        className={cx(
                          DRIVE_BROWSER_FILTER_BUTTON_CLASS,
                          driveSort === 'size_desc' && DRIVE_BROWSER_FILTER_BUTTON_ACTIVE_CLASS,
                        )}
